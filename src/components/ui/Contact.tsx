...
export default function Contact() {
  ...
  return (
    <section id='contacto' className='flex flex-col items-center justify-center px-10 sm:px-15 py-10'>
      ...
      <form action='submit' onSubmit={handleSubmit} className='w-full sm:w-1/3 flex flex-col gap-4 sm:gap-5 bg-secondary/50 border-2 border-accent p-5 sm:px-8 sm:py-10 rounded-xl hover:border-primary transition-colors'>
